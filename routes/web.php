...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Hourly Programmings
    Route::resource('hourly-programmings', 'HourlyProgrammingController', ['except' => ['create', 'store', 'edit', 'update', 'show', 'destroy']]);

    // Seo Site Checks
    Route::resource('seo-site-checks', 'SeoSiteCheckController', ['except' => ['create', 'store', 'edit', 'update', 'show', 'destroy']]);

    // Website Monitorings
    Route::resource('website-monitorings', 'WebsiteMonitoringController', ['except' => ['create', 'store', 'edit', 'update', 'show', 'destroy']]);
